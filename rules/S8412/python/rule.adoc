 ...
 * FastAPI - Path Operation Decorators - https://fastapi.tiangolo.com/tutorial/first-steps/#define-a-path-operation-decorator[Official FastAPI documentation explaining the use of specific HTTP method decorators]
